"""HTTP client for ServiceTitan API."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.servicetitan.io/v2"
...
class ServiceTitanClient:
    def __init__(self, api_token: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-ServiceTitan-Connector/1.0.0"
        }
    ...
    async def get_projectrecord(self, projectrecord_id: str) -> dict[str, Any]:
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            resp = await client.get(f"{self.base_url}/projects/{projectrecord_id}", headers=self.headers)
            if resp.status_code == 200:
                return resp.json()
