"""Settings panel for ServiceTitan Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__servicetitan_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=servicetitan_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_servicetitan"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("ServiceTitan Settings & Accounts", level=2),
